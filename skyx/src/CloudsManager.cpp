...
namespace SkyX
{
	...
	void CloudLayer::_registerCloudLayer(Ogre::Pass* CloudLayerPass)
	{
		...
		// TODO
		CloudLayerPass->createTextureUnitState("Cloud1.dds")->setTextureAddressingMode(Ogre::TextureUnitState::TAM_WRAP);
		CloudLayerPass->createTextureUnitState("c22n.dds")->setTextureAddressingMode(Ogre::TextureUnitState::TAM_WRAP);
		CloudLayerPass->createTextureUnitState("c22.dds")->setTextureAddressingMode(Ogre::TextureUnitState::TAM_WRAP);

...
void PythonQtPrivate::disconnectAllSignalReceivers()
{
    QList<PythonQtSignalReceiver*> signalReceivers = _signalReceivers.values();
    foreach(PythonQtSignalReceiver *signalReceiver, signalReceivers)
    {
        signalReceiver->disconnectAndRemoveSignalHandlers();
        signalReceiver->disconnect();
    }
}

//! \note Added by realXtend Tundra project.
void PythonQtPrivate::deleteAllSignalReceivers()
{
    QList<PythonQtSignalReceiver*> signalReceivers = _signalReceivers.values();
    _signalReceivers.clear();
    foreach(PythonQtSignalReceiver *signalReceiver, signalReceivers)
